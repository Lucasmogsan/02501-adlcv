...
def image_to_patches(image, patch_size, image_grid=True):
    ...
    if image_grid:
        ...
        """
        #print(f'shape of patches 0: {image.shape}')
        patches = rearrange(image, 'b c (nph ph) (npw pw) -> b c nph ph npw pw', nph=num_patches_h, npw=num_patches_w, ph=patch_h, pw=patch_w)
        #print(f'shape of patches 1: {patches.shape}')
        """
        ...
        #print(f'shape of patches 2: {patches.shape}')
    else:
        """
        ...
        patches = rearrange(patches, 'b c nph ph npw pw -> b (nph npw) (c ph pw)')
        #print(f'shape of patches 2: {patches.shape}')
        #Oneliner: patches = rearrange(image, 'b c (nph ph) (npw pw) -> b (nph npw) (ph pw c)', ph=patch_h, pw=patch_w)
...
if __name__ == "__main__":
    ...
    print(f'data type of input images:  {example_images.dtype}')
