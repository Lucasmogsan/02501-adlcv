...
def train(device='cpu', T=500, img_size=16, input_channels=3, channels=32, time_dim=256):
    ...
    for epoch in pbar:
        ...
        for images, labels in train_loader:
            ...
            # predict labels of x_t using the Classifier (output logits)
            predicted_logits = model(x_t, t)

            # Compute the loss (on logits and labels as we're using pytorchs CrossEntropyLoss)
